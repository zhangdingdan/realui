<template>
     <nav>
       <v-app-bar app flat>
            ...
            <v-spacer></v-spacer>
            <v-btn :to="{name:'RobotControl'}" id="robotcontrol" text color="indigo">
                <v-icon>mdi-cursor-move</v-icon>
                <span>Robot</span>
            </v-btn>

            <v-spacer></v-spacer>
            <v-btn :to="{name:'Telecontrol'}" id="telecontrol" text color="indigo">
          ...
          <!--  <v-spacer></v-spacer>
            ...
            -->
            <v-spacer></v-spacer>
            <v-icon color="indigo lighten-2">{{batteryIcon}}</v-icon>{{battery}}%
       </v-app-bar>
    </nav>
</template>
